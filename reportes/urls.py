...
from reportes.views import ListarFactura, GenerarInformeTotal, GenerarInformeTotalExcel, GenerarPdfFactura, ReporteDias
...
urlpatterns = [
    ...
    path('reportesDias/',login_required(ReporteDias.as_view()), name='reporteDias'),
]
